...
image: "/img/comics/hire-the-independent-implementer.webp"
---
...
**The partner programs got big enough to bend incentives.** Anthropic's commitment to train 30,000 Accenture professionals as Claude practitioners is real developer education and it also has a distribution effect, and both of those are true at once without anyone intending harm. The effect is what the principal has to plan around: an Accenture-led enterprise AI engagement now starts from Claude-on-Anthropic whether or not Claude is the right model for that workload. The same structure applies at Deloitte, Cognizant, and Infosys, and to OpenAI's, Google's, and AWS's partner channels. This principle is about the incentive shape, not about any vendor's conduct.
